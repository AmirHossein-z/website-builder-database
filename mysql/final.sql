...
INSERT INTO `customer` VALUES (651,'hossein','mosavi','09200000000',1111111111,'az@gmail.com',1,1),(989,'ali','zare','09200000000',1111111110,'aa@gmail.com',1,1),(1091,'amir','mohammadi','09100000000',1111111111,'e@gmail.com',1,1);
...
INSERT INTO `employee` VALUES (1,'Reza','Dehghani','09000000000','0975421232','hello.dehghani@gmail.com',1),(2,'AmirHossein','Zareian','09000000000','0974552232','no@gmail.com',1),(3,'Ali','Moghimi','09000540000','0975421232','no@gmail.com',2);
/*!40000 ALTER TABLE `employee` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `employee_buy`
--

DROP TABLE IF EXISTS `employee_buy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `employee_buy` (
  `employeeID` int DEFAULT NULL,
  `buyID` int DEFAULT NULL,
  KEY `buyID` (`buyID`),
  KEY `employeeID` (`employeeID`),
  CONSTRAINT `employee_buy_ibfk_1` FOREIGN KEY (`buyID`) REFERENCES `buy` (`ID`),
  CONSTRAINT `employee_buy_ibfk_2` FOREIGN KEY (`employeeID`) REFERENCES `employee` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `employee_buy`
--

LOCK TABLES `employee_buy` WRITE;
/*!40000 ALTER TABLE `employee_buy` DISABLE KEYS */;
/*!40000 ALTER TABLE `employee_buy` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `reply` VALUES (1,'you can buy subscription from your panel vial this link','1400-10-18',3,1),(2,'we showed you how to buy a domain with this video','1400-12-18',3,3);
...
INSERT INTO `wallet` VALUES (1,101000000,651),(2,199990000,989),(3,900000,1091);
...
-- Dump completed on 2022-01-11 13:00:40
